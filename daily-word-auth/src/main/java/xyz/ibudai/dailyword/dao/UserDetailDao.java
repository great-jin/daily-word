...
public interface UserDetailDao extends BaseMapper<UserDetail> {
     ...
     *
     * @param entities List<UserDetail> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<UserDetail> entities);
     ...
     */
    int insertOrUpdateBatch(@Param("entities") List<UserDetail> entities);
